...
def get_dataloader(batch_size=10, COCO_DIR='/home/zhaobo/Data/coco', instance_whitelist=None, stuff_whitelist=None, coco_include_other=False):
    coco_train_image_dir = os.path.join(COCO_DIR, 'images/train2017')
    coco_val_image_dir = os.path.join(COCO_DIR, 'images/val2017')
